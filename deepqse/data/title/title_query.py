...
# For Deep-QSE
class TitleQueryDataset(DEDataset):
    ...
    def parse_line(self, line):
        ...
        return query, title, body_sents, start_index, lang


class TitleQueryCollate(DECollate):
    def tokenize_body_sents(self, bodies, titles, queries):
        ...
        body_indexes = []
        for body_sents, title, query in zip(bodies, titles, queries):
            ...
            for sent in body_sents:
                ...
                tokenized_tok = (
                    ["<s>"] + tokenized_query + ["</s>"] + tokenized_title + ["</s>"] +  tokenized_sent + ["</s>"]
                )
    ...
    def __call__(self, data):
        queries, titles, bodies, start_indexes, langs = zip(*data)
