...
class QueryKVPosTitleDataset(TitleSentDataset):
    pass


class QueryKVPosTitleCollate(QueryKVCollate):
    ...
    def __call__(self, data):
        ...
        tokenized_queries, query_lens = self.tokenize_query_title(queries, titles)
        (
            tokenized_bodies,
            sents_num,
            body_indexes,
